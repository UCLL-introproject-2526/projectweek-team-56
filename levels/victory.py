...
try:
    ...
    import level_1, level_2, level_3, level_4

def load_level_data(level_num):
    if level_num == 1: return level_1.get_level_data()
    elif level_num == 2: return level_2.get_level_data()
    elif level_num == 3: return level_3.get_level_data()
    elif level_num == 4: return level_4.get_level_data()
    return None

def main():
    pygame.init()
    screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
    pygame.display.set_caption("Merging Mario")
    ...
    platforms, enemies, items, goal = load_level_data(current_level)
